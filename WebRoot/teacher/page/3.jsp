...
table tr td{ font-size:12px;}
	...
	cityList['国家级'] = ['教学改革重点项目','教学改革一般项目'];
	cityList['省级'] = ['教学改革重点项目','教学改革一般项目'];
	cityList['校级'] = ['重点项目（含自制仪器设备项目、学校A类项目、研讨课、双语教学)','一般项目（含学校B类项目)'];
	function changeCity( )
	{
    ...
    <iframe name="waiguan_hidden_frame" id="waiguan_hidden_frame" style="display:none"></iframe> 
            ...
            <div style="display: none">
					<input type="text" name="parameter" value="教学项目立项"/>
				</div>
                <tr>
                    <td height="30">
                        ...
                        <select name="selecttwo" id="city" >
                            <option disabled="disabled">--请选择区域--</option>
                        </select>
                    </td>
                </tr>
