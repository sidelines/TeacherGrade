...
<%@ include file="/teacher/checkSession.jsp" %>
<%
   ...
   else
   {
	...
	<body scroll=no topmargin="0" leftmargin="0">
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				<td colspan="3">
					<iframe frameBorder="0" scrolling="no" id="top" name="top" src="<%=path %>/teacher/top.jsp"
			...
			<tr>
				<td id='shang' width="162" height="100%">
					<iframe frameBorder="0" id="left" name="left" src="<%=path %>/teacher/left.jsp"
				...
				<td width="100%" height="100%">
					<iframe frameBorder="0" id="main" name="main" scrolling="no"
						src="<%=path %>/teacher/right.jsp" height="100%" width="100%"></iframe>
				</td>
			</tr>
		</table>
	</body>
