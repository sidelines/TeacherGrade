...
<body topmargin="0" leftmargin="2" rightmargin="2" bottommargin="2" style="background-color: #ffffff">
	<div id="masterdiv">
		<table border="0" width="158" id="table1" cellpadding="4" style="border-collapse: collapse">
			...
			<tr>
				<td>
					<p align="center">
						<font ><a target="_parent" href="<%=path%>/teacherLogOut.htm"><font >安全退出</font> <p/></a> <a target="_parent" href="#"><font >返回首页</font> </a>
						</font>
				</td>
			</tr>
		</table>
		...
		<span class="submenu" id="sub2">
			<TABLE cellSpacing="0" cellPadding="0" width="158" background="<%=path %>/images/menu_2.gif" border="0">
				<TR>
					<TD height=25 width="100%" align="center" bgcolor="#D6E0EF"><img border="0" src="<%=path %>/image/icon_arrow_r.gif" width="13" height="13"> <a class="menu" target="main" href="<%=path%>/checkteach.htm">审核教学业绩</a></TD>
				</TR>
				<%-- <TR>
